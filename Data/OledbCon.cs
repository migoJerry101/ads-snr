...
namespace ads.Data
{
    public class OledbCon : IDisposable
    {
        ...
        public OledbCon()
        {
            ...
            string strConn = "data source='199.84.0.201';Initial Catalog=" + Catalog + ";User Id=sa;password=@dm1n@8800;Trusted_Connection=false;MultipleActiveResultSets=true;TrustServerCertificate=True;Max Pool Size=200;";
